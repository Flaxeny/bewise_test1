...
Решение тестового задания компании [Bewise.ai](https://bewise.ai/) с использованием **FastAPI**,  **PostgreSQL**, **Docker**, **Docker-compose**, **SQLAlchemy**.
...
### 1. Clone repository
    ...
    $ git clone https://github.com/Flaxeny/bewise_test1.git
